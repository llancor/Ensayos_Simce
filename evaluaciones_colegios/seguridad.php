...
function simceRequireStudent(): array
{
    ...
    $s=simceDatabase()->prepare('SELECT a.id,a.nombre,a.curso,a.idgrado,a.colegio_id,c.id AS curso_id FROM alumnos a JOIN cursos c ON c.nombre=a.curso AND c.colegio_id=a.colegio_id WHERE a.id=:id AND c.id=:curso AND a.colegio_id=:school AND a.activo=1 AND c.activo=1');
