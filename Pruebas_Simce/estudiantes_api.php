...
$insert = $database->prepare('INSERT INTO alumnos (public_id, rut, rut_normalizado, nombre, curso, idgrado, nivel) VALUES (:public_id, :rut, :rut_normalizado, :nombre, :curso, :idgrado, :nivel)');
