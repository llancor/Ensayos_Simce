(function () {
    ...
    async function importStudents() {
        ...
        try {
            const response = await window.simceAuthenticatedFetch('estudiantes_api.php', {
                method: 'POST',
    ...
    async function loadSummary() {
        const response = await window.simceAuthenticatedFetch('estudiantes_api.php?action=summary');
        const result = await response.json();
    ...
    async function loadStudents() {
        ...
        const response = await window.simceAuthenticatedFetch('estudiantes_api.php?' + params.toString());
        const result = await response.json();
